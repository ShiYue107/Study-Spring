...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="<%=path%>/admin/adminedit_submit" 
	method="post"> 
	
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>管理员：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${admin.supername}" placeholder="" id="supername" name="supername">
			<input type="hidden" class="input-text" value="${admin.superid}" placeholder="" id="superid" name="superid">
		    <input type="hidden" class="input-text"  name="date" value="${admin.date}" />
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>密码：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" autocomplete="off" value="${admin.superpassword}" placeholder="密码" id="superpassword" name="superpassword">
		</div>
	</div>
	...
	<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="admin_save_submit();" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 保存</button>
