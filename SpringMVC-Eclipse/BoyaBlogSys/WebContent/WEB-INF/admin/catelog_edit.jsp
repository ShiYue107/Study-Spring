...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="<%=path%>/catelog/catelog_edit_sub" 
	method="post">
	   
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>分类名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${catelog.gname}" id="title" name="gname">
				<input type="hidden" class="input-text" value="${catelog.type}" placeholder="" id="" name="type">
				<input type="hidden" class="input-text" value="${catelog.gid}" placeholder="" id="" name="gid">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>分类详情：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${catelog.detail}" id="title" name="detail">
			</div>
		</div>
