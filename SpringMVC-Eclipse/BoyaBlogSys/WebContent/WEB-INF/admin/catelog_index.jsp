...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 分类管理 <span class="c-gray en">&gt;</span> 查看分类 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <a class="btn btn-primary radius" onclick="catelog_add('添加分类','<%=path%>/catelog/catelog_add')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加分类</a> <span class="l"></span> <span class="r">共有数据：<strong>${catelog_total}</strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<c:forEach items="${list}" var="c" varStatus="status">
				...
				<td><input type="checkbox" value="1" name=""></td>
					...
					<td>${c.gname}</td>
					<td>${c.detail}</td>
					<td class="f-14 td-manage"><a style="text-decoration:none" class="ml-5" onClick="catelog_edit('文章编辑',${c.gid})" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="catelog_del(this,${c.gid})" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
			</c:forEach>
			</tbody>
		</table>
...
/*分类-编辑*/
function catelog_edit(title,gid){
	...
	if(supername == null || supername == ""){
		...
		type: 2,
		title: title,
		content: "<%=path%>/catelog/catelog_edit/"+gid,
		 end: function () {
             location.reload();
          }
	     });
...
/*分类-添加*/
function catelog_add(title,url){
	var supername='${supername}';
	if(supername == null || supername == ""){
		layer.confirm('你登录已失效，请前往登录！', {
			  btn: ['关闭'] //按钮
...
function catelog_del(obj,id){
	...
	if(supername == null || supername == ""){
	  ...
	  layer.confirm('确认要删除吗？',function(index){
		...
		$.ajax({
			type:"post",
			url:"<%=path%>/catelog/catelog_del/"+gid,
